...
scanf("%s", users[userCount].password);
    ...
    // file me likh do   register kiya hua id aur pass.
    fprintf(fp, "%s %s\n",
            users[userCount].email,
...
fclose(fp);
    ...
    printf("Signup Successful!\n");   // FILE MAI SAVE HO JAYGA EMAIL AUR PASSWORD
}
...
int login() {
 ...
 printf(" Email or Password does not exist!\n");
    return 0;}
// DEFAULT PRODUCTS LOAD KARNA  JITNA BHI ADD HAI
...
// PRODUCTS LIST DIKHANA  KITNA PRODUCT HAI
void viewProducts() {
    printf("\n--- PRODUCT LIST ---\n");
...
// CART ME ITEM ADD KARNA  USER SA
// ============================================
void addToCart() {
    int id, qty;
...
// CHECKOUT → BILL PRINT KAREGA KITNA HUA HAI
...
// MAIN MENU  HAI JISMA SIGNUP,LOGIN,ADMIN PANNEL ,EXIST 
int main() {
